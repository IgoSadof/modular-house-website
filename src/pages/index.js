  ...
  return (
    <>
      ...
      <Layout
        ...
        ? `BY home - Cоздаем быстровозводимые модульные дома высокого качества.
        На нашем сайте вы можете купить готовый модульный дом или заказать индивидуальный проект.`
        : `BY home - Cоздаем быстровозводимые модульные дома высокого качества.
        На нашем сайте вы можете купить готовый модульный дом или заказать индивидуальный проект.`}
        page='main'
        component={Main} />

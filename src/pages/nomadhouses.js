  ...
  return (
    <>
      ...
      <Layout
        ...
        ? `Аренда дома в глэмпинге на Браславских озерах - это прекрасная возможность провести
        незабываемый отдых в окружении красивой природы. Nomad Houses - Современный отдых от городской суеты`
        : `Аренда дома в глэмпинге на Браславских озерах - это прекрасная возможность провести
        незабываемый отдых в окружении красивой природы. Nomad Houses - Современный отдых от городской суеты`}
        page="nomadhouses"
        component = {Watch}>

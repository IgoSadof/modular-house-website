  ...
  return (
    <>
      ...
      <Layout 
        ...
        ? `Model B - это одна из наших лучших разработок в сфере модульного строительства. 
        Данный модульный дом отличается высоким уровнем комфорта и уютной обстановкой. 
        Используя только экологически чистые материалы, мы создали дом, 
        который не только привлекателен внешне, но и функционален внутри.`
        : `Model B - это одна из наших лучших разработок в сфере модульного строительства. 
        Данный модульный дом отличается высоким уровнем комфорта и уютной обстановкой. 
        Используя только экологически чистые материалы, мы создали дом, 
        который не только привлекателен внешне, но и функционален внутри.`}

  ...
  return (
    <>
      ...
      <Layout 
        ...
        ? `Model I - это идеальный выбор для тех, кто ищет комфортный и просторный модульный дом. 
        Наша команда разработала проект, который сочетает в себе уют и функциональность. 
